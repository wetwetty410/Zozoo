...
public class AddFloorAdapter extends RecyclerView.Adapter<AddFloorAdapter.ViewHolder> {
    private List<Floor> tangList;
    private int mPosition = 0;
    OnClickAddFloor onClickThemBanFragment;

    public AddFloorAdapter(List<Floor> tangList, OnClickAddFloor onClickThemBanFragment) {
