...
public class SalesFoodsCookingAdapter extends RecyclerView.Adapter<SalesFoodsCookingAdapter.ViewHolder> {
    ...
    public SalesFoodsCookingAdapter(List<FoodOrder> monOrders, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_sales_list_foods_cooking, parent, false);
